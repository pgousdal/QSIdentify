...
QSIdentify 1.3.0 sends one allowlisted, read-only identification query and
...
qsidentify registry-create evidence-registry.json
qsidentify registry-add evidence-registry.json evidence-bundle.json
qsidentify registry-matrix evidence-registry.json
qsidentify contribution-create evidence-bundle.json --output contribution.zip
qsidentify contribution-review contribution.zip
